...
class Email_model extends CI_Model {
	...
	function account_suspension_email($email = '')
	{
		$system_name	=	$this->db->get_where('settings' , array('type' => 'system_name'))->row()->description;
		
		$email_msg		=	"Welcome to ".$system_name."<br />";
		$email_msg		.=	"Your account has been suspended. </br>";
		$email_msg		.=	"In case of you have any query, feel free to contact the administrator at ".$this->db->get_where('settings' , array('type' => 'system_name'))->row()->system_email."<br />";
		
		$email_sub		=	"Account Suspension email";
		$email_to		=	$email;
	...
	function password_reset_email($new_password = '',$account_type='' , $email = '')
	{
		...
		if($query->num_rows() > 0)
		{
			...
			$email_msg	.=	"Login URL : ".base_url()."<br />";
	...
	function do_email($msg=NULL, $sub=NULL, $to=NULL, $from=NULL)
	{
		...
		$msg	=	$msg."<br /><br /><br /><br /><br /><br /><br /><hr /><center><a href=\"https://www.compassionkenya.com/tools/\">&copy; 2017 Compassion Kenya Toolkit</a></center>";
