<?php
//$hID = $this->db->get_where('voucher_header',array("VNumber"=>$hID))->row();

$record = $this->db->get_where('voucher_header',array("VNumber"=>$param2,'icpNo'=>$param3))->row(); 
					   ...
					   <div id="voucher_print"> 	
						<table  class="table table-striped datatable">
							...
							<tbody>
								...
								<tr>
									<td colspan="6"><span style="font-weight: bold;">Vendor/Payee: </span> <?php echo $record->Payee;?></td>
								</tr>
