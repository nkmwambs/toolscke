...
<div class="row">
	<div class="col-sm-12">
		<?php 
			echo form_open(base_url() . 'exams.php/admin/kcpe/', array('id'=>'frm_user_add','class' => 'form-horizontal form-groups-bordered validate',"autocomplete"=>"off",'enctype' => 'multipart/form-data'));
		?>
