                    ...
                    <div class="panel-body">
                    	...
                    	<div class="row">
                    		<div class="col-sm-12">
                    				...
                    				<!-- <a href="<?=base_url();?>exams.php/admin/add_kcse_result" class="btn btn-default"><?=get_phrase('add_exam_results');?></a> -->
		                    		<a href="<?=base_url();?>exams.php/admin/download_kcse_results/<?=$start_of_year_date;?>" id="excel_download" class="btn btn-default"><?=get_phrase('download_results');?></a>									
		                    		<a href="<?=base_url();?>exams.php/admin/add_subject"  class="btn btn-default"><?=get_phrase('add_subject');?></a>
								
								<div class="btn-group">
		                    		<a href="<?=base_url();?>exams.php/admin/kcse/<?=strtotime('first day of january last year',$start_of_year_date);?>" 
		                    		...
		                    		<a href="<?=base_url();?>exams.php/admin/kcse/<?=strtotime('first day of january next year',$start_of_year_date);?>" 
		                    				...
		                    				<td>
		                    					<div class="btn-group">
													...
													<ul class="dropdown-menu dropdown-default pull-left" role="menu">
														...
														<li>
															<a target="__blank" href="<?=base_url();?>exams.php/admin/edit_kcse_results/<?=$row->rID;?>/<?=true;?>">
																 <i class="fa fa-eye"></i>
														...
														<!-- <li>
															<a href="<?=base_url();?>exams.php/admin/edit_kcse_results/<?=$row->rID;?>">
														...
														<li>
															<a href="#" onclick="confirm_action('<?=base_url();?>exams.php/admin/delete_kcse_result/<?=$row->rID;?>/<?=$start_of_year_date;?>')">
