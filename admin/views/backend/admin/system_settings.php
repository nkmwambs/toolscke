<hr />
    ...
    <div class="row">
    <?php echo form_open(base_url() . 'admin.php/admin/system_settings/do_update' , 
      array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
        <div class="col-md-6">
            ...
            <div class="panel-body form-horizontal form-groups-bordered">
                <?php echo form_open(base_url().'admin.php/updater/update' , array('class' => 'form-horizontal form-groups-bordered', 'enctype' => 'multipart/form-data'));?>
      ...
      ?>
        ...
        <div class="col-md-6">
            ...
            <?php echo form_open(base_url() . 'admin.php/admin/system_settings/upload_logo' , array(
...
<script type="text/javascript">
    $(".gallery-env").on('click', 'a', function () {
        skin = this.id;
        $.ajax({
            url: '<?php echo base_url();?>admin.php/admin/system_settings/change_skin/'+ skin,
            success: window.location = '<?php echo base_url();?>admin.php/admin/system_settings/'
        });
});
</script>