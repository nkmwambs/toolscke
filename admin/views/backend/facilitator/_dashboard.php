		       ...
		       <div class="panel-heading">
		       	...
		       	<div class="panel-body"  style="max-width:50; overflow: auto;">
				    	...
				    	?>
				    		...
				    		<div class="col-sm-3">
				    			<div class="col-sm-12" >
				    				<a class="btn btn-primary" target="_blank" href="<?php echo base_url();?><?php echo $app_key;?>.php/login/validate_login/<?php echo $this->session->userdata('login_user_id');?>/<?php echo $app_key;?>"><img src="<?php echo $icon;?>" title="<?=ucfirst($app_desc);?>"/></a>
				    			</div>
