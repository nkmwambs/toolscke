...
var baseurl = '<?php echo base_url();?>admin.php/';
</script>
...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content" style="width:100%;">
           ...
           <p class="mode">
            	<h2 style="color:red; font-weight:50;">
					<?php 
						if($mode==='inactive'){
							echo "<div class='well'>The system is under maintainance. Only super administrators can log in</div>";
						}
					?>
              </h2>
           </p>
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<?php if(!empty($authUrl)) { ?>
				...
				<a href="<?php echo $authUrl;?>" style="color:white;" class="btn btn-block btn-social btn-google">
					<i class="fa fa-google"></i>
					Login with Google
				</a>

			<?php }else{ ?>
				 <div><a class="btn btn-danger" style="color: white;" href="<?php echo base_url();?>login/logout">Bye <?php echo $userfirstname;?>. Login Failed. Logout from Google</a></b></div>
			<?php } ?>
			...
			<form method="post" role="form" id="form_login">
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="password" class="form-control has-feedback" name="password" id="password" placeholder="Password" autocomplete="off" />
			...
			<div class="login-bottom-links">
				<a href="<?php echo base_url();?>admin.php/login/forgot_password" class="link">
	...
	<script src="assets/js/neon-demo.js"></script>
			...
			<!-- Font Awesome -->
	<script src="https://use.fontawesome.com/f54c0ed615.js"></script>
