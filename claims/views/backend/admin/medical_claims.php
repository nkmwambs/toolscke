...
function format ( d ) {
    return '<table class="table" style="border-left: 5px solid red;">'+
    	'<thead>'+
    	'<tr>'+
    	'<th style="font-weight:bold;">Incident ID: </th>'+
    	'<th style="font-weight:bold;">ICP ID: </th>'+
    	'<th style="font-weight:bold;">Cluster: </th>'+
    	'<th style="font-weight:bold;">Child Name: </th>'+
    	'<th style="font-weight:bold;">Treatment Date: </th>'+
    	'<th style="font-weight:bold;">Incident Category: </th>'+
    	'<th style="font-weight:bold;">Incident Sub Category: </th>'+
...
$(document).ready(function(){
		...
		var datatable = $('#table_export,table.display').DataTable({
		       ...
		       "ajax": {
		           "url": "<?php echo base_url();?>claims.php/medical/ajax_list",
		           "type": "POST",
		           "data": function(data){
		       ...
		       "columnDefs": [
			       	...
			       	{ 
			           "targets": [17,18], //first column / numbering column
			           "orderable": false //set not orderable
			       	},
			       	{
                		"targets": [ 1,2,3,5,6,8,9,10,11,13,15,16],
                		"visible": false,
                		"searchable": false,
                		"class": "hidden_column"
            		}
...
<div id="status" style="display: none;">
    <select class="form-control" name="">
    	...
    	<option value="-2"><?=get_phrase('reinstated');?></option>
