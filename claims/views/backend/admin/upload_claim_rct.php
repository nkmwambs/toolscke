	...
	<div class="col-sm-12">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
				    ...
				    <div class="col-sm-12">
				        <?php echo form_open(base_url() . 'claims.php/medical/upload_medical_receipts/claims/' , array('id'=>'','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
				 ...
				 <p></p>
					...
					<a href="<?php echo base_url();?>claims.php/medical/ziparchive/claims/<?php echo $claim->rec;?>/receipt" class="btn btn-orange btn-icon"><i class="fa fa-cloud-download"></i>Download All</a>
