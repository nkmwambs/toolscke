...
function format ( d ) {
    return '<table class="table" style="border-left: 5px solid red;">'+
        ...
        '<td>'+d[13]+'</td>'+
        '<td>'+d[14]+'</td>'+
        '<td><a href="#" onclick=\'showAjaxModal("<?=base_url();?>claims.php/modal/popup/modal_view_voucher/'+d[16]+'/'+d[2]+'");\'>'+d[16]+'</td><a>'+
        '<td>'+d[9]+'</td>'+
        '<td>'+d[10]+'</td>'+        
        '<td>'+d[20]+'</td>'+
        '<td>'+d[11]+'</td>'+
...
<div id="status" style="display: none;">
    <select class="form-control" name="">
    	...
    	<option value="8"><?=get_phrase('reinstated_after_declined_by_PF');?></option><!--Was -2 -->
    	<option value="9"><?=get_phrase('reinstated_after_declined_by_HS');?></option><!--Was -3 -->
