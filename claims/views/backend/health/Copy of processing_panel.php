...
<div id="member-entry_<?=$claim['details']->rec;?>" class="member-entry">
			...
			<div id="entry_<?=$claim['details']->rec;?>" class="member-details">
				...
				<div class="row info-list">
					...
					<div class="col-sm-4">
						<?php
							echo "<iframe src=\"".base_url()."/uploads/document/medical/claims/".$claim['details']->rec."/".$claim['docs']['receipt']."\" width=\"100%\" style=\"height:100%\"></iframe>";
						?>
					</div>
					...
					<div class="col-sm-4">
						<?php
							echo "<iframe src=\"".base_url()."/uploads/document/medical/claims/".$claim['details']->rec."/".$claim['docs']['approval']."\" width=\"100%\" style=\"height:100%\"></iframe>";
						?>
					</div>
