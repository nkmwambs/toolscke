...
<button type="button" id="" class="btn btn-blue"><?php echo get_phrase('mass_processes');?></button>
	<button type="button" id="" class="btn btn-blue dropdown-toggle" data-toggle="dropdown">
		...
		<ul class="dropdown-menu dropdown-blue" role="menu">
			<li  style="">
				<a href="#" onclick="mass_processing('approve');">
			...
			<li  style="">
				<a href="#" onclick="mass_commenting('decline');">
			...
			<li  style="">
				<a href="#" onclick="mass_commenting('not_decline');">
			...
			<li  style="">
				<a href="#" onclick="mass_processing('pay')">
...
$(document).ready(function() {
		...
		var datatable = $('#table_export,table.display').DataTable({
		       ...
		       "ajax": {
		           "url": "<?php echo base_url();?>claims.php/health/ajax_list",
		           "type": "POST",
		           "data": function(data){
...
function mass_processing(action){
	...
	BootstrapDialog.confirm("<?=get_phrase("are_you_sure_you_want_to_perform_this_process?");?>",function(result){
		
		if(!result){
			BootstrapDialog.show({
				title:"<?=get_phrase('alert');?>",
				message:"<?=get_phrase("process_aborted");?>"
			});
		}else{

		var url = "<?php echo base_url();?>claims.php/health/mass_processing/"+action;
...
function mass_commenting(action){
	...
	BootstrapDialog.confirm("<?=get_phrase("are_you_sure_you_want_to_perform_this_process?");?>",function(result){
		...
		if(!result){
			...
			showAjaxModal("<?=base_url();?>claims.php/modal/popup/modal_mass_comment/"+action);				
		}
