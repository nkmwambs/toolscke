	...
	<div class="col-sm-12">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<?php echo form_open(base_url() . 'claims.php/health/decline_claim/'.$param2 , array('id'=>'frm_medical_claim','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
