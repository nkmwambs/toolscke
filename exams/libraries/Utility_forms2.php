	...
	function render_item_list(){
		...
		if($this->add_form){
			$output .= "
						<div class='row'>
							<div class='col-xs-12'>
								<a href='".base_url().$add['href']."' class='btn btn-default'>Add New Record 
						...
						<div class='col-xs-12'>
							<table class='table datatable'>
								<thead><tr><th>Action</th>";
									foreach($list_array[0] as $key=>$value){
