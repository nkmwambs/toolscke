                    	...
                    	<div class="row">
                    		<div class="col-sm-12">
								...
								<div class="btn-group">
		                    		...
		                    		<a href="<?=base_url();?>exams.php/partner/kcse/<?=strtotime('first day of january next year',$start_of_year_date);?>" 
		                    				...
		                    				<td>
		                    					<div class="btn-group">
													...
													<ul class="dropdown-menu dropdown-default pull-left" role="menu">
														...
														<li>
															<a href="<?=base_url();?>exams.php/partner/edit_kcse_results/<?=$row->rID;?>">
														...
														<li>
															<a href="#" onclick="confirm_action('<?=base_url();?>exams.php/partner/delete_kcse_result/<?=$row->rID;?>/<?=$start_of_year_date;?>')">
