...
class Api extends CI_Controller
{
    ...
    function prod_methods(){
       ...
       $dashboard_month = "2018-03-31";
       $count_of_fcps = "18";
       $fcp_in_dashboard = 0;

       $result = $this->finance_dashboard->build_dashboard($dashboard_month,$count_of_fcps,$fcp_in_dashboard);
    ...
    function display_dashboard(){
        ...
        $dashboard_month = strtotime("2020-03-31");
