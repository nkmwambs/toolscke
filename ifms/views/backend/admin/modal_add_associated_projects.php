       ...
       <div class="panel-heading">
           <div class="panel-title">
              <i class="fa fa-plus-circle"></i>
                 <?php echo get_phrase('add_associated_projects');?>
           </div>
       </div>
       		...
       		<?php 
				...
				?>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="specific_fund_code" id="specific_fund_code" value="<?php echo $record->specific_fund_code;?>" class="form-control" readonly="readonly" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea class="form-control" readonly="readonly" name="description" id="description"><?php echo $record->description;?></textarea>
						</div>
					</div>
