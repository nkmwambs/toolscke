...
$icps_civs_open_income_statement .= "LEFT JOIN `users` ON `voucher_body`.`icpNo`=`users`.`fname`"; 
$icps_civs_open_income_statement .= "WHERE `civa`.`open`='1' AND users.cname='".$this->session->cluster."'";
