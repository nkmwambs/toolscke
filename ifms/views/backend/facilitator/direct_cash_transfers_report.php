    ...
    <div class='col-xs-12'>
        <table class='table table-striped datatable'>
            ...
            <?php foreach($direct_cash_transfers['dct_records'] as $fcp_number => $fcp_record){?>
                <tr>
                    <td><?=$fcp_number;?></td>
                    <td><a target = '_blank' href='<?php echo base_url();?>ifms.php/facilitator/direct_cash_transfer_vouchers/<?=$tym;?>/<?=$fcp_number;?>' class='btn btn-default'><i class='fa fa-eye'></i></a> <?=number_format($fcp_record['total_dct_expense'],2);?> </td>
