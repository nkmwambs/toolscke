	...
	<div class="col-sm-12">
			...
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<?php echo form_open(base_url() . 'ifms.php/facilitator/decline_budget_item/'.$param2 ."/".$param3.'/'.$param4, array('id'=>'frm_medical_claim','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
