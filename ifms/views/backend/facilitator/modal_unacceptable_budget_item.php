	...
	<div class="col-sm-12">
			...
			<div class="panel panel-info">
				...
				<div class="panel-heading">
					<div class="panel-title"><?=get_phrase('unacceptable_budget_item');?></div>						
				</div>
										
				<div class="panel-body">
					<?php echo form_open(base_url() . 'ifms.php/facilitator/modal_unacceptable_budget_item/'.$param2 ."/".$param3.'/'.$param4, array('id'=>'frm_medical_claim','class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
						...
						<div class="form-group">
							<div class="col-sm-12">
								<button class="btn btn-warning btn-icon"><i class="fa fa-times-rectangle"></i><?=get_phrase('decline');?></button>
							</div>
						</div>	
