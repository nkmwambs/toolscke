<div class="row">
			<div class="col-sm-12">
				...
				<a href="<?=base_url();?>ifms.php/facilitator/scroll_cash_journal/<?=$tym;?>/<?=$project;?>" class="btn btn-info btn-icon pull-right"><i  class="fa fa-arrow-left" aria-hidden="true"></i><?=get_phrase('cash_journal');?></a>
			</div>
</div>
<hr />
            		...
            		<i class="entypo-plus-circled"></i>
						...
						<table  class="table">
							...
							<tbody>
								...
								<tr>
									<td colspan="6"><span style="font-weight: bold;">Vendor/Payee: </span> <?php echo $voucher_header->Payee;?></td>
								</tr>
