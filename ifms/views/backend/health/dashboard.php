...
<div class="row">
									...
									<button type="button" id="" class="btn btn-blue"><?=get_phrase("field_office_report");;?></button>
										<button type="button" id="" class="btn btn-blue dropdown-toggle" data-toggle="dropdown">
											...
											<ul class="dropdown-menu dropdown-blue" role="menu">
												<li  style="">
													<a href="<?=base_url();?>ifms.php/health/fo_fund_balance_report/<?=$tym;?>" target="__blank"><?php echo get_phrase('fund_balance_report');?></a>
												</li>
																		
												<li  style="" class="divider"></li>
												
												<li  style="">
													<a href="<?=base_url();?>ifms.php/health/fo_expense_report/<?=$tym;?>" target="__blank"><?php echo get_phrase('expense_report');?></a>
												</li>
													...
													?>
														...
														<div style='margin-bottom:5px;' class="btn-group right-dropdown">
															...
															<ul class="dropdown-menu dropdown-blue" role="menu">
																...
																<li style="">
																	<a href="<?php echo base_url();?>ifms.php/health/cash_journal/<?php echo $tym;?>/<?=$rw->fname;?>"><?php echo get_phrase('cash_journal');?></a>
																</li>
																...
																<li style="">
																	<a href="<?php echo base_url();?>ifms.php/health/plans/<?=$tym;?>/<?=$rw->fname;?>"><?php echo get_phrase('budget');?></a>
																</li>
  ...
  <div class="row">  
	...
	var url = '<?php echo base_url();?>ifms.php/health/dashboard/'+dt+'/'+cnt+'/'+flag;
