<div class="row">
	...
	<div class="panel-body"  style="max-width:50; overflow: auto;">	
		...
		<div class="row">
			<div class="col-sm-12">
				<a href="#" onclick="<?php echo base_url();?>ifms.php/modal/popup/modal_new_voucher/"  id="resetBtn" class="btn btn-default btn-icon icon-left hidden-print pull-left">
	...
	<div class="panel-footer">
		<div class="row">
			<div class="col-sm-12">
				...
				<div data-toogle="modal" data-target=""  id="resetBtn_footer" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_new_voucher');" class="btn btn-default btn-icon icon-left hidden-print pull-left">
				      <?php echo get_phrase('reset');?>
				     <i class="entypo-plus-circled"></i>
				</div>
				<!--		
				<button type="submit" id="btnPostVch_footer" class="btn btn-default btn-icon icon-left hidden-print pull-left">
				     <?php echo get_phrase('post');?>
				     <i class="entypo-thumbs-up"></i>
				</button>
					
				<div style="display: none" id='btnDelRow_footer' class="btn btn-default btn-icon icon-left hidden-print pull-left">
				      <?php echo get_phrase('remove_item_row');?>
				     <i class="entypo-minus-circled"></i>
				</div>					
						
				<div id='addrow_footer' class="btn btn-default btn-icon icon-left hidden-print pull-left">
				      <?php echo get_phrase('new_item_row');?>
				     <i class="entypo-plus-circled"></i>
				</div>-->
