...
$obj = $this->db->get_where('voucher_header',array("VNumber"=>$VNum,"icpNo"=>$this->session->center_id));

if($obj->num_rows() ==  0) {echo "<div class='well' style='text-align:center;'>Voucher Number ".$VNum." not available</div>"; exit;}

$record = $this->db->get_where('voucher_header',array("VNumber"=>$VNum,"icpNo"=>$this->session->center_id))->row(); 
