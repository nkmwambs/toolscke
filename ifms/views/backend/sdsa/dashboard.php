...
<div class="row">
													...
													?>
														...
														<div style='margin-bottom:5px;' class="btn-group right-dropdown">
															...
															<ul class="dropdown-menu dropdown-blue" role="menu">
																...
																<li style="">
																	<a target="__blank" href="<?php echo base_url();?>ifms.php/accountant/cash_journal/<?php echo $tym;?>/<?=$rw->fname;?>"><?php echo get_phrase('cash_journal');?></a>
																</li>
  ...
  <div class="row">  
	...
	var url = '<?php echo base_url();?>ifms.php/sdsa/dashboard/'+dt+'/'+cnt+'/'+flag;
