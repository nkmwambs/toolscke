<div class="row">
			<div class="col-sm-12">
				...
				<a href="<?=base_url();?>ifms.php/facilitator/cash_journal/<?=$tym;?>/<?=$project;?>" class="btn btn-info btn-icon pull-right"><i  class="fa fa-arrow-left" aria-hidden="true"></i><?=get_phrase('cash_journal');?></a>
			</div>
</div>
<hr />
