...
<!--Alertify-->
<script src="<?php echo base_url();?>assets/js/alertify.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/js/alertify.min.js" type="text/javascript"></script>
