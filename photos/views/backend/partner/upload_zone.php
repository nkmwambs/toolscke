...
<div class="row">
	<div class="col-sm-12 well" id="errMsg">
    ...
    <script>
        ...
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
          url: "<?php echo base_url();?>photos.php/partner/upload_photo", // Set the url
          paramName: "file",
          thumbnailWidth: 80,
          thumbnailHeight: 80,
          parallelUploads: 50,
          ...
          if (this.files.length) {
			    ...
			    for (_i = 0, _len = this.files.length; _i < _len - 1; _i++) {
			        if( this.files[_i].name === file.name ) {
			            this.removeFile(file);
			            $('#errMsg').append(file.name+'- Not listed. Duplicate file name found <br/>')
			        }
			    }
			}		
		            	...
		            	buttons:[
		            		{
				                ...
				                action: function(dialogRef){
				                    $.ajax({
				                    	url:'<?php echo base_url();?>photos.php/partner/photo_notification/<?php echo $this->session->project_id;?>',
