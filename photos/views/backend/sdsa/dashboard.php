                            	...
                            	<table class="table table-striped">
                            		...
                            		?>
                            			<tr>
                            				...
                            				<td><a class="btn" href="#" onclick="showAjaxModal('<?php echo base_url();?>photos.php/modal/popup/modal_detailed_list/new/<?php echo $rows->num;?>');"><?php echo $this->db->get_where('files',array('group'=>$rows->num,'status'=>1))->num_rows()?></a></td>
                            				<td><a class="btn" href="#" onclick="showAjaxModal('<?php echo base_url();?>photos.php/modal/popup/modal_detailed_list/accepted/<?php echo $rows->num;?>');"><?php echo $this->db->get_where('files',array('group'=>$rows->num,'status'=>2))->num_rows()?></a></td>
                            				<td><a class="btn" href="#" onclick="showAjaxModal('<?php echo base_url();?>photos.php/modal/popup/modal_detailed_list/rejected/<?php echo $rows->num;?>');"><?php echo $this->db->get_where('files',array('group'=>$rows->num,'status'=>3))->num_rows()?></a></td>
                            				<td><a class="btn" href="#" onclick="showAjaxModal('<?php echo base_url();?>photos.php/modal/popup/modal_detailed_list/reinstated/<?php echo $rows->num;?>');"><?php echo $this->db->get_where('files',array('group'=>$rows->num,'status'=>4))->num_rows()?></a></td>
                            			</tr>
                            		<?php
                            			endif;
                            			endforeach;
