			...
			<div class="tab-pane box active" id="participants" style="padding: 5px">
               ...
               <div class="box-content">
               	...
               	<div class="row">
               		<div class="col-sm-12">	
               			<?php 
							echo form_open(base_url() . 'training.php/facilitator/manage_register/list_users/'.$event->event_id.'#add_participants', array('id'=>'frm_user_list','class' => 'form-horizontal form-groups-bordered validate',"autocomplete"=>"off",'enctype' => 'multipart/form-data'));
						?>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<select class="form-control select2" multiple="multiple" name="projects[]">
										<?php 
											$icps = $this->db->get_where("users",array("userlevel"=>'1',"department"=>0,'cname'=>$this->session->cluster))->result_object();
											$icp_arr = array();
											foreach($icps as $icp){
               	...
               	<div class="row">
				    ...
				    <?php
						...
						echo form_open(base_url() . 'training.php/facilitator/manage_register/add_participants/'.$event->event_id, array('id'=>'frm_user_add','class' => 'form-horizontal form-groups-bordered validate',"autocomplete"=>"off",'enctype' => 'multipart/form-data'));
					?>
						<div class="form-group">
...
<script>
	...
	$(".mark").click(function(){
		...
		var url = "<?=base_url();?>training.php/facilitator/manage_register/mark_participation/<?=$event->event_id;?>";
	...
	$("#btn_erase").click(function(){
		...
		var items = {};
		var url = '<?=base_url();;?>training.php/facilitator/manage_register/erase_participants/<?=$event->event_id;?>';
