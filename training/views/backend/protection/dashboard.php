  ...
  $(document).ready(function() {
		...
		var $calendar =$('#notice_calendar').fullCalendar({
					...
					eventMouseover:function(event, jsEvent, view){
					    ...
					    var layer ='<div style="background-color:white;color:black;border-radius:5px;" class="action-buttons col-sm-4 pull-right"><div style="padding-right:10px;cursor:pointer;" id="events-register" class="fc-transparent pull-right"><i id="regbut'+event.id+'" class="fa fa-eye"></i></div> &nbsp; ';
					    ...
					    $("#regbut"+event.id).click(function() {
						   window.open('<?=base_url();?>training.php/facilitator/register/'+event.id, '_blank');
						});
					    
					    
					    $("#evalbut"+event.id).click(function() {
						   window.open('<?=base_url();?>training.php/facilitator/evaluation', '_blank');
						});
